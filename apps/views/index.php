		...
		<div id="carouselIndexControls" class="carousel slide col-6 offset-3" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="<?= base_url('assets/img/1.jpg') ?>" alt="First slide"> <!-- mettre un script php sur src ? -->
				</div>
			...
			<a class="carousel-control-next" href="#carouselIndexControls" role="button" data-slide="next">
