<div class="container-fluid">
	...
	<?= form_open('UserController/updatePassword','class="col-12"'); ?>
			...
			<label class="col-12">Votre ancien mdp :</label>
				<input type="text" class="form-control" id="oldpwd" name="oldPwd" value="<?php if(isset($user)) echo $user['oldPwd'] ?>">
			...
			<label class="col-12">Confirmer le mot de passe :</label>
				<input type="text" class="form-control" id="verifPwd" name="verifPwd" value="<?php if(isset($user)) echo $user['verifPwd'] ?>">
