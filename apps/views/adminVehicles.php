			...
			if(isset($cars)) {
				foreach($cars as $car) {
					...
					?><div class="col-12 col-sm-6">
						...
						<p>Kilom√©trage : <?= $car->getMileage(); ?></p>
					...
					<?php if($car->getDisponibility()) echo anchor("CarController/deleteCar/$id", "Supprimer vÈhicule",['class' => 'btn btn-danger col-6']);?>
					<?= anchor("CarController/updateCar/$id", "Modifier vÈhicule",['class' => 'btn btn-primary col-6']);?>
