...
class ProfilController extends CI_Controller {
	...
	$data["title"] = "Loca-Auto";

	$this->load->view('templates/header', $data);
	$this->load->view('templates/navbar', $data);
	//$this->load->view('index', $data);
	//$this->load->view('templates/cookie', $data);
	//$this->load->view('listVehicles', $data);
	//$this->load->view('login', $data);
	//$this->load->view('signin', $data);
	//$this->load->view('userProfil', $data);
	//$this->load->view('userRent', $data);
	//$this->load->view('adminRent', $data);
	//$this->load->view('adminClients', $data);
	//$this->load->view('registerRentAdmin', $data);
	//$this->load->view('registerReturnAdmin', $data);
